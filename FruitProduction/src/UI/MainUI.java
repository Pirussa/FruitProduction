...
public class MainUI implements Runnable {
    ...
    public void run() {
        ...
        do {
            try {
                System.out.printf("Choose an option:%n1 - Load Data From CSV File.%n2 - Get a List of countries (Production in year > Q).%n3 - Calculate the minimum amount of countries that produce over a certain quantity%n4 - Sort by Consecutive Years.%n");
