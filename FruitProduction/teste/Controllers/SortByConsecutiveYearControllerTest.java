...
class SortByConsecutiveYearControllerTest {
    ...
    @Test
    public void sortByConsecutiveYears() {
        ...
        Map<Country, Integer> expetecMap = new LinkedHashMap<>();
        expetecMap.put(new Country("Portugal"), 2); expetecMap.put(new Country("Greece"), 1); expetecMap.put(new Country("France"), 3);

        for (Map.Entry<Country, Integer> entry : actualMap.entrySet()) {
